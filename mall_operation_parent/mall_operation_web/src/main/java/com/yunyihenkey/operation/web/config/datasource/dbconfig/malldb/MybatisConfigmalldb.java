package com.yunyihenkey.operation.web.config.datasource.dbconfig.malldb;
...
@MapperScan(basePackages = { "com.yunyihenkey.basedao.malldb.basemapper",
		"com.yunyihenkey.operation.dao.malldb.mapper" }, sqlSessionTemplateRef = "malldbSqlSessionTemplate")
