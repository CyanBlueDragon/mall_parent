...
public class ShoppingmallOrderInfoServiceImpl implements ShoppingmallOrderInfoService {
    ...
    @Override
    public List<ShoppingmallOrderInfoVo> selectAllByPage(String mallId, String orderCode, String memberAccount, int[] orderStatus) {
        return shoppingmallOrderInfoMapper.selectAll(mallId, orderCode, memberAccount, orderStatus);
    }

    @Override
    public ShoppingmallOrderInfoVo selectByOrderCode(String orderCode) {
