...
public interface ShoppingmallOrderInfoService extends BaseService<ShoppingmallOrderInfo, Long> {
     ...
     */
    List<OrderInfoResult> selectAllByPage(String mallId, String orderCode, String memberAccount, int[] orderStatus);
     ...
     * @Param [orderCode]
     * @return com.yunyihenkey.basedao.malldb.basevo.OrderInfoResult
     */
