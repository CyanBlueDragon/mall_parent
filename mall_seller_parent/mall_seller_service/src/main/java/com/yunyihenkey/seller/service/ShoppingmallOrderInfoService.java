...
public interface ShoppingmallOrderInfoService extends BaseService<ShoppingmallOrderInfo, Long> {
     ...
     */
    List<ShoppingmallOrderInfoResult> selectAllByPage(String mallId, String orderCode, String memberAccount, int[] orderStatus);
     ...
     * @Param [orderCode]
     * @return com.yunyihenkey.basedao.malldb.basevo.ShoppingmallOrderInfoResult
     */
