package com.yunyihenkey.seller.web.vo.param.orderController;
 ...
 */
public class OrderInfoParam extends PageParam {
    ...
    public OrderInfoParam(String mallId, String orderCode, String memberAccount, int[] orderStatus) {
        this.mallId = mallId;
        this.orderCode = orderCode;
        this.memberAccount = memberAccount;
