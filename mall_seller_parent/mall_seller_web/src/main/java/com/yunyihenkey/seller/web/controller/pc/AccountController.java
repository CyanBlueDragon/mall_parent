...
public class AccountController extends BaseController {
    ...
    @Autowired
    private SellerShopMoneyCashService sellerShopTakeCashLogService;
    @Autowired
    private SellerShopMoneyBusinessService sellerShopMoneyBusinessService;
    @Autowired
    ...
    public Object getBusinessLogList(HttpServletRequest request, @RequestBody GetBusinessLogListParam param)
        ...
        List<SellerShopMoneyBusiness> list = sellerShopMoneyBusinessService
    ...
    public Object getTakeCashLogList(HttpServletRequest request, @RequestBody GetTakeCashLogListParam param)
        ...
        // 查询分页
        PageHelper.startPage(param.getPageNum(), param.getPageSize());
        List<SellerShopMoneyCash> list = sellerShopTakeCashLogService.getByShopId(Long.valueOf(sellerUser.getShopId()));

        return new ResultInfo<>(SystemCodeEnum.SELLER, CodeEnum.SUCCESS, new PageInfo<>(list));
    }

    @PostMapping("getTakeCashLogChart")
    public Object getTakeCashLogChart(HttpServletRequest request, @RequestBody GetTakeCashLogChartParam param)
            throws Exception {
        ...
        // 开始时间
        Date startDate = DateUtil.addMonths(DateUtil.getCurrentDayZero(),
                -GetTakeCashLogChartEnum.getByValue(param.getTime()).getMonth());

        List<GetTakeCashLogChartResult> list = sellerShopTakeCashLogService
                .getTakeCashLogChart(Long.valueOf(sellerUser.getShopId()), startDate);
