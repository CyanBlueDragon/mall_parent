 ...
 */
public class QueryAftersaleParam extends PageParam {
    ...
    public QueryAftersaleParam(String mallId, String orderCode, String memberAccount, String[] aftersaleStatus) {
        this.mallId = mallId;
        this.orderCode = orderCode;
        this.memberAccount = memberAccount;
        this.aftersaleStatus = aftersaleStatus;
